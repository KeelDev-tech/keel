...
def main(argv=None):
    ...
    parser.add_argument('command',choices=['doctor','demo','benchmark','qualify'])
    ...
    try:
        ...
        return 3 if result.get('status') in ('DEMO_FAILED','BENCHMARK_FAILED','QUALIFICATION_FAILED') else 0
