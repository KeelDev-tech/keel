...
1. **No head-to-head conversion data.** Keel's proof figure is
   94 verified submissions (as of 2026-09-15) — a volume figure from the
...
4. **Execution-layer efficacy is private and unverified publicly.** The
   ...
   the public repo. The 94-verified-submissions figure is the only public evidence it works at all.
...
- Does the 94-verified-submissions figure risk sounding like a spam-cannon boast?
