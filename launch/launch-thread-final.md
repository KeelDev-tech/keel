...
5/ Proof the discipline works: the private production pipeline's ledger holds 94 verified submissions (as of 2026-09-15; the pipeline runs continuously, so the live count only grows). The repo itself makes no submission
