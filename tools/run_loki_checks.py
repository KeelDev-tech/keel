#!/usr/bin/env python3
"""Run unchanged guarded suites and bind their exact outputs to the 0.12 source."""
import argparse
import hashlib
import json
...
from tools.loki_inventory import inventory, read_file
...
def main(argv=None):
    ...
    report = {'schema': 'keel.loki.test_binding.v1',
